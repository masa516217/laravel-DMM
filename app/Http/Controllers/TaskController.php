...
*/
    ...
    */
        ...
        //タスク編集成功
        $request->session()->flash('front.task_edit_succes', true);
        //詳細閲覧画面にリダイレクトする
    ...
    public function delete(Request $request, $task_id)
    {
        ...
        if ($task !== null) {
            $task->delete();
            $request->session()->flash('front.task_delete_succes', true);
        }
